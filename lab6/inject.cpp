...
int main() {
	char processName[] = "cmd.exe";
	char Dll[] = "C:\\IATdll.dll";
	...
	HANDLE ThreadHandle = CreateRemoteThread(ProcessHandle, NULL, 0, (LPTHREAD_START_ROUTINE)LoadLibrary, baseAdd, 0, NULL);
	if (0 == ThreadHandle) {
